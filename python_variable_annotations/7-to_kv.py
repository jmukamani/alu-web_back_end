...
def to_kv(k: str, v: Union[int, float]) -> Tuple[str, float]:
    """
    Return a tuple where the first element is the string `k` and the second element is 
    ...
    Returns:
        Tuple[str, float]: A tuple where the first element is `k` and the second element is
